...
# set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { sdcard_chip_detect }]; #IO_L6N_T0_VREF_16 Sch=pio[07]
# set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { sdcard_csb }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
...
# set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { gnd }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
